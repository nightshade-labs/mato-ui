...
export const TWOB_ANCHOR_ERROR__WRONG_EXITS_ACCOUNT = 0x1774 // 6004
/** WrongPricesAccount: Wrong prices account */
export const TWOB_ANCHOR_ERROR__WRONG_PRICES_ACCOUNT = 0x1775 // 6005
/** WrongTokenAccount: Wrong token account */
export const TWOB_ANCHOR_ERROR__WRONG_TOKEN_ACCOUNT = 0x1776 // 6006
/** InvalidOrder: Invalid order submission */
export const TWOB_ANCHOR_ERROR__INVALID_ORDER = 0x1777 // 6007
/** BookNotUpToDate: Book not up to date */
export const TWOB_ANCHOR_ERROR__BOOK_NOT_UP_TO_DATE = 0x1778 // 6008
/** PositionNotEnded: Cannot close open position. */
export const TWOB_ANCHOR_ERROR__POSITION_NOT_ENDED = 0x1779 // 6009
/** NotEnoughDeposits: Deposits are too low for specified flow. */
export const TWOB_ANCHOR_ERROR__NOT_ENOUGH_DEPOSITS = 0x177a // 6010
/** LiquidityPositionUnhealthy: Liquidity position has debt. */
export const TWOB_ANCHOR_ERROR__LIQUIDITY_POSITION_UNHEALTHY = 0x177b // 6011
/** LiquidityPositionStillActive: Liquidity position still active. */
export const TWOB_ANCHOR_ERROR__LIQUIDITY_POSITION_STILL_ACTIVE = 0x177c // 6012
/** NoDebt: Liquidity position has no debt. */
export const TWOB_ANCHOR_ERROR__NO_DEBT = 0x177d // 6013
/** MarketIsPaused: Market is paused. */
export const TWOB_ANCHOR_ERROR__MARKET_IS_PAUSED = 0x177e // 6014
/** RemainingOrders: Market still has orders. */
export const TWOB_ANCHOR_ERROR__REMAINING_ORDERS = 0x177f // 6015
/** AccountStillUsed: Too early to close account. */
export const TWOB_ANCHOR_ERROR__ACCOUNT_STILL_USED = 0x1780 // 6016
/** TradePositionExpired: Too late to close position. */
export const TWOB_ANCHOR_ERROR__TRADE_POSITION_EXPIRED = 0x1781 // 6017
...
if (process.env.NODE_ENV !== 'production') {
  twobAnchorErrorMessages = {
    ...
    [TWOB_ANCHOR_ERROR__LIQUIDITY_POSITION_UNHEALTHY]: `Liquidity position has debt.`,
