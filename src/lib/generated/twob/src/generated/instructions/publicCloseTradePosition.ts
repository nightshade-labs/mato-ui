...
export const PUBLIC_CLOSE_TRADE_POSITION_DISCRIMINATOR = new Uint8Array([
  84, 88, 98, 249, 38, 129, 179, 30,
])

export function getPublicCloseTradePositionDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    PUBLIC_CLOSE_TRADE_POSITION_DISCRIMINATOR,
  )
}

export type PublicCloseTradePositionInstruction<
  ...
  InstructionWithAccounts<
    [
      ...
      TAccountBaseReceiver extends string
        ? WritableAccount<TAccountBaseReceiver>
        : TAccountBaseReceiver,
      TAccountQuoteReceiver extends string
        ? WritableAccount<TAccountQuoteReceiver>
...
export type PublicCloseTradePositionInstructionData = {
  discriminator: ReadonlyUint8Array
  referenceIndex: bigint
}

export type PublicCloseTradePositionInstructionDataArgs = {
  referenceIndex: number | bigint
}

export function getPublicCloseTradePositionInstructionDataEncoder(): FixedSizeEncoder<PublicCloseTradePositionInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: PUBLIC_CLOSE_TRADE_POSITION_DISCRIMINATOR,
    }),
  )
}

export function getPublicCloseTradePositionInstructionDataDecoder(): FixedSizeDecoder<PublicCloseTradePositionInstructionData> {
...
export function getPublicCloseTradePositionInstructionDataCodec(): FixedSizeCodec<
  PublicCloseTradePositionInstructionDataArgs,
  PublicCloseTradePositionInstructionData
> {
  return combineCodec(
    getPublicCloseTradePositionInstructionDataEncoder(),
    getPublicCloseTradePositionInstructionDataDecoder(),
  )
}

export type PublicCloseTradePositionAsyncInput<
...
> = {
  ...
  referenceIndex: PublicCloseTradePositionInstructionDataArgs['referenceIndex']
}

export async function getPublicCloseTradePositionInstructionAsync<
  TAccountSigner extends string,
  TAccountPayer extends string,
  TAccountBaseReceiver extends string,
  TAccountQuoteReceiver extends string,
...
>(
  input: PublicCloseTradePositionAsyncInput<
    TAccountSigner,
    TAccountPayer,
    TAccountBaseReceiver,
    TAccountQuoteReceiver,
  ...
  PublicCloseTradePositionInstruction<
    TProgramAddress,
    TAccountSigner,
    TAccountPayer,
    TAccountBaseReceiver,
...
> {
  ...
  const originalAccounts = {
    ...
    baseReceiver: { value: input.baseReceiver ?? null, isWritable: true },
    quoteReceiver: { value: input.quoteReceiver ?? null, isWritable: true },
  ...
  return Object.freeze({
    ...
    data: getPublicCloseTradePositionInstructionDataEncoder().encode(
      args as PublicCloseTradePositionInstructionDataArgs,
    ),
    programAddress,
  } as PublicCloseTradePositionInstruction<
    TProgramAddress,
    TAccountSigner,
    TAccountPayer,
    TAccountBaseReceiver,
...
export type PublicCloseTradePositionInput<
  TAccountSigner extends string = string,
  TAccountPayer extends string = string,
  TAccountBaseReceiver extends string = string,
  TAccountQuoteReceiver extends string = string,
...
export function getPublicCloseTradePositionInstruction<
  TAccountSigner extends string,
  TAccountPayer extends string,
  TAccountBaseReceiver extends string,
  TAccountQuoteReceiver extends string,
  ...
  TProgramAddress extends Address = typeof TWOB_ANCHOR_PROGRAM_ADDRESS,
>(
  input: PublicCloseTradePositionInput<
    TAccountSigner,
    TAccountPayer,
    TAccountBaseReceiver,
    TAccountQuoteReceiver,
...
export type ParsedPublicCloseTradePositionInstruction<
  TProgram extends string = typeof TWOB_ANCHOR_PROGRAM_ADDRESS,
...
> = {
  ...
  data: PublicCloseTradePositionInstructionData
}

export function parsePublicCloseTradePositionInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>,
): ParsedPublicCloseTradePositionInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getPublicCloseTradePositionInstructionDataDecoder().decode(
      instruction.data,
    ),
  }
}
