...
export type ProvideLiquidityInstruction<
...
export function getProvideLiquidityInstructionDataDecoder(): FixedSizeDecoder<ProvideLiquidityInstructionData> {
...
export function getProvideLiquidityInstructionDataCodec(): FixedSizeCodec<
  ProvideLiquidityInstructionDataArgs,
  ProvideLiquidityInstructionData
> {
  return combineCodec(
    getProvideLiquidityInstructionDataEncoder(),
    getProvideLiquidityInstructionDataDecoder(),
  )
}

export type ProvideLiquidityAsyncInput<
...
> {
  ...
  return Object.freeze({
    ...
    data: getProvideLiquidityInstructionDataEncoder().encode(
      args as ProvideLiquidityInstructionDataArgs,
    ),
    programAddress,
  } as ProvideLiquidityInstruction<
    TProgramAddress,
    TAccountAuthority,
    TAccountBaseMint,
    TAccountQuoteMint,
...
export type ParsedProvideLiquidityInstruction<
  TProgram extends string = typeof TWOB_ANCHOR_PROGRAM_ADDRESS,
...
export function parseProvideLiquidityInstruction<
...
>(
  ...
  return {
    ...
    data: getProvideLiquidityInstructionDataDecoder().decode(instruction.data),
  }
}
