    ...
    <nav className="sticky top-0 z-50 flex h-14 items-center justify-between border-b border-white/8 bg-[color:var(--color-page-bg)]/80 px-4 backdrop-blur-xl sm:px-6">
      <div className="flex items-center gap-6">
        <Link to="/" className="flex items-center gap-2.5">
          <div className="flex size-8 items-center justify-center rounded-lg bg-[color:var(--color-accent-strong)]/15">
            <Activity className="size-4 text-[color:var(--color-accent-strong)]" />
          </div>
